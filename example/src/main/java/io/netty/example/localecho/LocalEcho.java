...
public final class LocalEcho {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            // are handled by the same event loop thread which drives a certain nio channel
            // to reduce the communication latency between nio channels and local channels.
