...
public class WebSocketServerHandshakerFactory {
    ...
    /**
     * Constructor specifying the destination web nio location
     *
     * @param webSocketURL
     *            URL for web nio communications. e.g "ws://myhost.com/mypath".
     *            Subsequent web nio frames will be sent to this URL.
     * @param subprotocols
     *            CSV of supported protocols. Null if sub protocols not supported.
     * @param allowExtensions
     *            Allow extensions to be used in the reserved bits of the web nio frame
     */
     ...
     *
     * @return A new WebSocketServerHandshaker for the requested web nio version. Null if web
     *         nio version is not supported.
     */
    ...
    /**
     * Return that we need cannot not support the web nio version
     */
