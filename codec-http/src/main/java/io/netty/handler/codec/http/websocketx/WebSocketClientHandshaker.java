...
/**
 * Base class for web nio client handshake implementations
 */
public abstract class WebSocketClientHandshaker {
     ...
     *
     * @param uri
     *            URL for web nio communications. e.g "ws://myhost.com/mypath". Subsequent web nio frames will be
     *            sent to this URL.
     * @param version
     *            Version of web nio specification to use to connect to the server
     * @param subprotocol
    ...
    /**
     * Returns the URI to the web nio. e.g. "ws://myhost.com/path"
     */
    public URI uri() {
        return uri;
    }
    ...
    /**
     * Version of the web nio specification that is being used
     */
