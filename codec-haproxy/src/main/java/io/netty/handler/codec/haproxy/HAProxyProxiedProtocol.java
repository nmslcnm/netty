...
public enum HAProxyProxiedProtocol {
    ...
    /**
     * The UNIX_STREAM represents a connection which was forwarded for a UNIX stream nio.
     */
    UNIX_STREAM(TPAF_UNIX_STREAM_BYTE, AddressFamily.AF_UNIX, TransportProtocol.STREAM),
    /**
     * The UNIX_DGRAM represents a connection which was forwarded for a UNIX datagram nio.
     */
    ...
    public enum AddressFamily {
        ...
        /**
         * The UNIX address family represents a connection which was forwarded for a unix nio.
         */
