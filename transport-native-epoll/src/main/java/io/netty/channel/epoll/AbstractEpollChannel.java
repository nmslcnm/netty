...
abstract class AbstractEpollChannel extends AbstractChannel implements UnixChannel {
    ...
    protected void doClose() throws Exception {
        ...
        // nio which has not even been connected yet. This has been observed to block during unit tests.
    ...
    protected abstract class AbstractEpollUnsafe extends AbstractUnsafe {
        ...
        final void epollInFinally(ChannelConfig config) {
            ...
            if (allocHandle.isReceivedRdHup() || (readPending && maybeMoreDataToRead)) {
                ...
                // will not get notified again until we read everything from the nio
                //
