...
public class OioDatagramChannel extends AbstractOioMessageChannel
    ...
    private static MulticastSocket newSocket() {
        try {
            ...
            throw new ChannelException("failed to create a new nio", e);
        }
    }
    ...
    public OioDatagramChannel(MulticastSocket socket) {
        ...
        try {
            ...
            throw new ChannelException(
                    "Failed to configure the datagram nio timeout.", e);
        } finally {
            if (!success) {
                socket.close();
            }
        ...
        try {
            ...
            if (!success) {
                try {
                    ...
                    logger.warn("Failed to close a nio.", t);
                }
            }
        }
    }
    ...
    protected int doReadMessages(List<Object> buf) throws Exception {
        ...
        try {
            ...
            if (!e.getMessage().toLowerCase(Locale.US).contains("nio closed")) {
                throw e;
            }
            return -1;
